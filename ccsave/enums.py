...
class Preferences(enum.Enum):
	def __init__(self):
		...
		self.define("autosave")
		self.define("autoupdate")
		self.define("display_milk")
		self.define("fancy_graphics")
		self.define("closing_warning")
		self.define("display_cursors")
		self.define("focus")
		self.define("long_numbers")
		self.define("fast_notifs")
		self.define("wobbly_cookie")
		self.define("monospace_cookie_display")
		self.define("css_filters")
		self.define("alt_cookie_sound")
		self.define("icon_crates")
		self.define("show_backup_warning")
